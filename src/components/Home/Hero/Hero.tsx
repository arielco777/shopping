...
const Hero = () => {
    return (
        <div className="relative w-full lg:h-[50rem] h-[37rem] lg:pt-[6.5rem] bg-white flex justify-around items-start xl:px-40 px-0">
            <div className="absolute lg:w-[83.4%] w-3/4 h-full bg-black rounded-t-full hidden lg:block lg:-bottom-[77%] lg:-left-[18.55%]"></div>
            <div className="absolute lg:w-[84%] w-3/4 h-full bg-white rounded-b-full hidden lg:block lg:-bottom-[23.6%] lg:-right-[19%]"></div>
